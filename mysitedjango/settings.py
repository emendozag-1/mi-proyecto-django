...
SECRET_KEY = 'django-insecure-g3ia4vq057+h%yhsg7$f4el$u*ui9ck&#ajo!=%*4co-)l1_u8'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [
  "formularioinscripcion-apa5ctf0f9h3gmgz.canadacentral-01.azurewebsites.net",
  "localhost", "127.0.0.1"
]
...
DATABASES = {
    'default': {
        'ENGINE': 'mssql',
        'NAME': 'REC_JAE',
        'USER': 'jalvarez@mysqlrededucativa',
        'PASSWORD': 'JosRol9000!',
        'HOST': 'mysqlrededucativa.database.windows.net',
        'PORT': '1433',
        'OPTIONS': {
